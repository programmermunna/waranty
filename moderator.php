                             ...
                             <table class="table">
                                ...
                                if(isset($_POST['search'])){
                                 ...
                                 ?>
                                    ...
                                    <td class="p-3 border whitespace-nowrap"><div class="text-center"><img style="widht:50px;height:50px;border-radius:50px;margin:0 auto;" src="upload/<?php echo $row['file']?>" alt="Image"></div></td>                                       
